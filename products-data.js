...
const PRODUCTS = [
  ...
  // ---- TUNNELING ----
  { id:"TN-001", name:"Rock Drill Seal Kit",   partNo:"TN-RD-SK01",  brand:"Atlas Copco",       sector:"Tunneling", category:"Valve & Rebuild Kits", imgType:"kit",      desc:"Seal kit for Atlas Copco rock drills used in tunneling operations." },
  { id:"TN-002", name:"DTH Hammer Piston",     partNo:"TN-DTH-P02",  brand:"Ingersoll Rand",    sector:"Tunneling", category:"Valve & Rebuild Kits", imgType:"bearing",  desc:"Down-the-hole hammer piston for hard rock tunneling applications." },
  { id:"TN-003", name:"Air Leg Cylinder Kit",  partNo:"TN-AL-CK03",  brand:"Chicago Pneumatic", sector:"Tunneling", category:"Valve & Rebuild Kits", imgType:"separator",desc:"Cylinder and piston kit for air leg rock drills in tunnel boring." },
